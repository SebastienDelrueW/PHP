...
/* 1- Créer une base de données "repertoire" avec une table "contact" :
	  ...
	  photo VARCHAR(255)
		...
		type_contact ENUM('ami', 'famille', 'professionnel', 'autre') DEFAULT NULL,
...
if (!empty($_POST)) {  
	...
	if (empty($contenu)) {
		...
		{	
			$photo = 'photos/' .$_FILES['photo']['name'];  // $photo est le chemin relatif de la photo enregistré dans la base 
